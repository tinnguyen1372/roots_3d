...
import numpy as np
merge_files("./straight_scans_4/straight_scan_1", removefiles=False)
merge_files("./straight_scans_4/straight_scan_2", removefiles=False)
merge_files("./straight_scans_4/straight_scan_3", removefiles=False)
merge_files("./straight_scans_4/straight_scan_4", removefiles=False)
output_files = ["./straight_scans_4/straight_scan_1_merged.out", "./straight_scans_4/straight_scan_2_merged.out", "./straight_scans_4/straight_scan_3_merged.out", "./straight_scans_4/straight_scan_4_merged.out"]
...
import numpy as np
starting_point_tx = [(1,1.1,1), (1,1.1,2) , (2,1.1,2) , (2,1.1,1)]
...
plt.plot(rx[:, 0], rx[:, 2], 'bo-', label='Rx path')
plt.xlabel('x (m)')
plt.ylabel('z (m)')
plt.legend()
plt.axis('equal')
